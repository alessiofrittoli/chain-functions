# Contributing to Chain Functions ⛓️

We’re excited that you’re interested in contributing to Chain Functions! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/chain-functions/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/chain-functions).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/chain-functions.git
```
...
Thank you for helping improve Chain Functions! 🎉